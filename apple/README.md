...
- `ZotEatsKit/`: Swift package for models, services (dining, campus retail, busyness, gym), typical-busyness engine, and tests. Builds and tests on Linux and macOS: `swift test --package-path apple/ZotEatsKit`.
